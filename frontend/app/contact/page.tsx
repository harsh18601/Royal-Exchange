        ...
        >
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              <div className="p-3 bg-luxury-ruby/10 rounded-xl">
                <Mail className="text-luxury-ruby w-6 h-6" />
              </div>
              <div>
                <h4 className="text-white font-bold mb-1">Email Our Desk</h4>
                <p className="text-gray-400">concierge@royal-exchange.com</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="p-3 bg-luxury-ruby/10 rounded-xl">
              ...
              <div>
                <h4 className="text-white font-bold mb-1">Direct Wholesale Line</h4>
                <p className="text-gray-400">+1 (800) ROYAL-GEM</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="p-3 bg-luxury-ruby/10 rounded-xl">
              ...
              <div>
                <h4 className="text-white font-bold mb-1">Sourcing HQ</h4>
                <p className="text-gray-400">77 Diamond Tower, Geneva, Switzerland</p>
              </div>
            </div>
          </div>
        </motion.div>
